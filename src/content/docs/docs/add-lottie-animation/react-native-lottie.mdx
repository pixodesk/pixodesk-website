...
You can add Lottie animations to a React Native Expo project using the `lottie-react-native` and `@lottiefiles/dotlottie-react` packages. Expo apps work on both iOS and Android.
<SpacerBottom />
...
- Open your animation in **`2D Animator`** directly from your `assets/animations` folder.
