...
This End User License Agreement is a legal agreement between you and Pixodesk LIMITED that governs your use of the Pixodesk Animator application.
By using the Pixodesk Animator application, You accept and agree to be bound by this License Agreement and its terms. If you do not agree with the terms and conditions of this License Agreement, you may not use the Pixodesk Animator application. You agree to comply with all applicable third-party terms of agreement when using the application.
...
Pixodesk LIMITED is and remains the owner of any intellectual property rights with respect to the Pixodesk Animator application. You shall not acquire any ownership of the Pixodesk Animator application as a result of Your purchase of the License or Your use of the Pixodesk Animator application.
...
Pixodesk Animator application may include various open-source software components in or with the Pixodesk Animator application, each of which is owned by a third-party and is subject to its own applicable license terms and conditions. All libraries are provided on an "as-is" basis, and Pixodesk Animator makes no express or implied warranties of any kind with respect thereto and assumes no liability for any damages regarding the use or operation of any such library.


### RESERVATION OF INTELLECTUAL PROPERTY RIGHTS
Pixodesk Animator and any authorized copies are the intellectual property of and are owned by Pixodesk LIMITED. The software is licensed, not sold. This agreement does not grant you any intellectual property rights in the Pixodesk Animator.
...
You must comply with applicable third-party terms of agreement when using the Pixodesk Animator application.
...
- "Acknowledgement". The EULA is concluded between Pixodesk LIMITED and the End-User only, and not with Apple. Pixodesk LIMITED, not Apple, is solely responsible for the licensed Pixodesk Animator application and the content thereof. The EULA may not provide for usage rules for licensed Pixodesk Animator applications that are in conflict with, the Apple Media Services Terms and Conditions as of the Effective Date (which You acknowledge You have had the opportunity to review). If there are any conflicts between these Terms and the Apple Store Terms of Service, the Apple Store Terms of Service will apply.

- "Scope of license". The license granted to the End-User for the licensed Pixodesk Animator application is limited to a non-transferable license to use the licensed Pixodesk Animator application on any Apple-branded Products that the End-User owns or controls and as permitted by the Usage Rules set forth in the Apple Media Services Terms and Conditions.


- "Reservation of intellectual property rights". In the event of any third-party claim that the licensed Pixodesk Animator application or the End-User's possession and use of that licensed Pixodesk Animator application infringes on a third-party's intellectual property rights, Pixodesk LIMITED, not Apple, reserves the right to investigate, defend, settle, and discharge of any such intellectual property infringement claim.

- "Maintenance and support". Pixodesk LIMITED, not Apple, is solely responsible for providing any maintenance and support services with respect to the licensed Pixodesk Animator application, as specified in the EULA, or as required under applicable law. If you need any support with the licensed Pixodesk Animator application, please contact Pixodesk LIMITED, not Apple as they are under no obligation to help with any support or maintenance questions arising out of use of the licensed Pixodesk Animator application.

- "Warranty disclamer". In the event of any failure of the Pixodesk Animator application to conform to any applicable warranty, you may notify Apple, and Apple will refund the purchase price for the Pixodesk Animator application to you; and that, to the maximum extent permitted by applicable law, Apple will have no other warranty obligation whatsoever with respect to the Pixodesk Animator application, and any other claims, losses, liabilities, damages, costs or expenses attributable to any failure to conform to any warranty will be our sole responsibility.

- "Liability limitations, Product Claims". Pixodesk LIMITED, and not Apple, is responsible for addressing claims relating to the Pixodesk Animator application and Your possession and/or use of it, including, but not limited to: (i) product liability claims; (ii) any claim that the Pixodesk Animator application fails to conform to any applicable legal or regulatory requirement; and (iii) claims arising under consumer protection, privacy, or similar legislation, including in connection with Pixodesk Animator application's use of the HealthKit and HomeKit frameworks.
